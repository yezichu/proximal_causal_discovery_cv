from data.two_proxies import generate_samples
        ...
        for i in tqdm(range(num_runs), desc=f"{causal_key} runs"):
            ...
            for sample_size in sample_sizes:
                ...
                for _ in range(num_samples_per_run):
                    samples = generate_samples(gamma_w=1,num_samples=sample_size, type=causal_key)
...
if __name__ == "__main__":
    ...
    output_path='decs_results_IV.json',
    use_parallel=True,
    n_jobs=50
)
